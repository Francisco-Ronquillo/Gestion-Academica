...
while option!='5':
   limpiarPantalla()
   menuMain=Utilidades('Menu Academico',['Estudiante','Profesor','Periodo','Asignatura','Nivel','Notas','Salir'])
   ...
   if option=='3':
      ...
      while option!='5':
         limpiarPantalla()
         menuPeriodos=Utilidades('Menu Periodo',['Registrar','Actuazilar','Eliminar','Consultar','Salir'])
